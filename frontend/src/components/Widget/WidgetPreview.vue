<template>
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <p class="text-sm text-gray-600 mb-4">
            This widget shows your total received balance publicly. Anyone with
        ...
        <div class="space-y-4">
            ...
            <p class="text-xs text-gray-500 flex items-center space-x-1">
                <Info :size="12" />
                <span
                    >The widget is cached for 60 seconds and rate-limited to 60
                    requests per minute per IP.</span
                >
            </p>
        </div>
    </div>
